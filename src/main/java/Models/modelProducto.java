...
public class modelProducto {
    ...
    /* INSERT */
    public void crearProducto(String nombre, String descripcion, float precio, int stock, int categoria) throws SQLException {
    ...
    /* READ */
    public void leerProducto() throws SQLException {
        ConnectionSQLServer SQL = new ConnectionSQLServer();
        myConn = SQL.connectSQL();
